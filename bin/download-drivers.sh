...
rm -fr $GERMANIUM_FOLDER/drivers/binary
mkdir $GERMANIUM_FOLDER/drivers/binary
...
# Chrome drivers
#
mkdir -p $GERMANIUM_FOLDER/drivers/binary/chrome/linux/64
mkdir -p $GERMANIUM_FOLDER/drivers/binary/chrome/linux/32
mkdir -p $GERMANIUM_FOLDER/drivers/binary/chrome/win/32
mkdir -p $GERMANIUM_FOLDER/drivers/binary/chrome/mac/32
...
cd $GERMANIUM_FOLDER/drivers/binary/chrome/linux/64
unzip /tmp/germaniumdrivers/chromedriver_linux64.zip
cd $GERMANIUM_FOLDER/drivers/binary/chrome/linux/32
unzip /tmp/germaniumdrivers/chromedriver_linux32.zip
cd $GERMANIUM_FOLDER/drivers/binary/chrome/win/32
unzip /tmp/germaniumdrivers/chromedriver_win32.zip
cd $GERMANIUM_FOLDER/drivers/binary/chrome/mac/32
unzip /tmp/germaniumdrivers/chromedriver_mac32.zip

#
# Firefox drivers
#
mkdir -p $GERMANIUM_FOLDER/drivers/binary/firefox/linux/64
mkdir -p $GERMANIUM_FOLDER/drivers/binary/firefox/win/32
mkdir -p $GERMANIUM_FOLDER/drivers/binary/firefox/mac/32
...
# IE Driver
#
mkdir -p $GERMANIUM_FOLDER/drivers/binary/ie/win/32
mkdir -p $GERMANIUM_FOLDER/drivers/binary/ie/win/64
...
cd $GERMANIUM_FOLDER/drivers/binary/ie/win/32
unzip /tmp/germaniumdrivers/IEDriverServer_Win32_$IEDRIVER_VERSION.zip
cd $GERMANIUM_FOLDER/drivers/binary/ie/win/64
